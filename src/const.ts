...
export const WEDDING_DATE = dayjs.tz("2026-10-24 12:00", "Asia/Seoul")
export const WEDDING_DATE_FORMAT = `2026년 10월 24일 12시${WEDDING_DATE.minute() === 0 ? "" : " m분"}`

// 예식 당월 휴무일. 켈린더에 표시하기 위함.
// 예: 예식일 8월 -> 8월 15일 광복절
export const HOLIDAYS = [5, 9]

export const LOCATION = "서울 드래곤시티 그랜드머큐어 호텔\n2층 랑데부홀"
...
export const WEDDING_HALL_POSITION = [126.9608277, 37.5324262]

// 네이버 지도의 웨딩홀 장소 ID
// 네이버 지도 웹페이지에서 웨딩홀 검색 후 URL에서 확인 가능.
// 예: https://map.naver.com/p/entry/place/958174664 -> 958174664
export const NMAP_PLACE_ID = 958174664

// 카카오 지도의 웨딩홀 장소 ID
// 카카오 지도 웹페이지에서 웨딩홀 검색 후 해당 장소에서 상세보기 클릭 시 URL에서 확인 가능.
// 예: https://place.map.kakao.com/59564823 -> 59564823
export const KMAP_PLACE_ID = 59564823

export const GMAP_PLACE_ID = "ChIJH_HwzwSifDURGhaBm8jpLs8"
